...
public class C04_Assertions { // Amazon anasayfaya gidin
    ...
    /*
        ...
        Ancak bu raporlama kodlar
        sorunsuz çalışıp bittiyse PASSED
        ...
        geri yekalan assertion'lar kontrol edilmemiş olur

        Eğer bir class çalıştığında
        tüm assertion'ların mutlaka gözden geçirilmesini istiyorsak
        her assertion için ayrı test method olışturabiliriz

        test methodlarının ismi de
        yaptığımız iş ile uyumlu olursa
        konsolda neyin çalışıp neyin çalışmadığını görebiliriz
    ...
    public void titleTest(){
        ...
        System.out.println("Bu satır,test passed olursa çalışır,  test fail olursa çalışmaz");
    }
