...
public class C01_MavenIlkTest {
    public static void main(String[] args) {
        ...
        /*
            13. satırı yazmamız mecburi değildir.
            Selenium 4.8 versiyonundan itibaren kendi Webdriver'ını oluşturmuştur
            biz 13. satırdaki gibi dışarıdan bir Webdriver tanımlamazsak
            Selenium otamatik olarak kendi Webdriver'ını devreye sokar.
         */
